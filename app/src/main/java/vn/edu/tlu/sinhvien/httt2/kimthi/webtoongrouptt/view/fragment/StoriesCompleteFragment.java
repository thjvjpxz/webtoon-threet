...
import vn.edu.tlu.sinhvien.httt2.kimthi.webtoongrouptt.databinding.FragmentStoriesCompleteBinding;
...
public class StoriesCompleteFragment extends Fragment {
    private FragmentStoriesCompleteBinding binding;
    private StoriesByTypeAdapter adapter;
    private StoryHomeViewModel viewModel;
    public StoriesCompleteFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStoriesCompleteBinding.inflate(inflater, container, false);


        viewModel = new ViewModelProvider(this).get(StoryHomeViewModel.class);
        adapter = new StoriesByTypeAdapter(new ArrayList<>(), TypeStoryConst.TYPE_COMPLETED);
    ...
    private void observer() {
        String type = TypeStoryConst.TYPE_STORY[TypeStoryConst.TYPE_COMPLETED];
